...
On first open the sample couple is **analyzed automatically** (lifetime path + tax strategy vs naive). Use **Run full plan** after edits; **Market stress test** runs Monte Carlo. After a full plan, **Longevity** tools compare fixed death ages and optional **stochastic mortality** trials.
